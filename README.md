...
| v3.1 | при ручнму запуску світлодіод Alarm зберігає високий стан, навіть після перезавантаження, поки його не буде ручного / автоматичного відбою повітряної тривоги |
